# Marketing · Semana 9 — Lanzamiento iPhone (orgánico)
...
Calculado con `evaluateOne` y la categoría Tecnología (referencia 6 % de los ingresos, colchón objetivo 3 meses de gastos), ya con el motor endurecido del 23/09. En estas compras las cifras no cambian: en un móvil pagado al contado manda el colchón, y eso el motor nuevo lo deja igual.
...
La prueba de estrés del 23/09 no lo cubre: sube el interés solo en préstamos de 120 meses o más (hipotecas). El crédito al consumo de 24–36 meses, que es justo el de los móviles, sigue sin penalizar el interés.

→ Arreglar en `lib/engine/` antes de tocar este ángulo (por ejemplo, que el coste total de los intereses cuente en el esfuerzo, o aplicar la subida de tipo también al crédito al consumo). Cuando esté, el vídeo «te cobran 364 € por esperar menos» es de los mejores que podemos hacer.

---

## 4. Contenidos

Numeración siguiendo la serie (el último fue V15, en la semana 8 del Tasador).

### V16 · Cuánto hay que tener ahorrado de verdad
...
### V17 · El plegable cuesta más que un coche
...
### V18 · Cobrar más no significa que te dé más
...
### V19 · Lo que te cuesta en horas de tu vida
...
### V20 · Reacción a comentarios
- **Gancho:** «Me habéis pedido que mire si os da para el iPhone con vuestros sueldos. Vamos.»
- Coger 3 comentarios reales de V16/V17 y calcularlos en directo. Si aún no hay, usar casos de r/askspain o r/SpainFIRE, sin nombres.
...
### Para V17 (el contraste móvil / coche)
```
...
### Para V18 (la paradoja de los dos sueldos)
```
...
| Día | Pieza | Nota |
| --- | --- | --- |
| Lun 28/09 | V16 | El de más recorrido: abre la serie |
| Mié 30/09 | C1 (carrusel) | Instagram; en TikTok como foto-carrusel |
| Vie 02/10 | V18 | La paradoja: el que más se comparte |
| Mié 15/10 | V17 | Víspera de las reservas del plegable |
| Vie 17/10 | V20 (reacciones) | Con comentarios ya acumulados |
| Jue 23/10 | V19 | Día de salida del plegable |
