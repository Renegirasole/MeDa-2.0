...
export const metadata: Metadata = {
  ...
  description:
    "Compara hasta 4 ofertas de coche, moto o vivienda con su precio, entrada, plazo e interés. Te decimos cuál te conviene según tu situación, no solo cuál es más barata.",
