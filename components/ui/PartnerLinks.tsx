  ...
  return (
    <div className={className}>
          ...
          <li key={l.href}>
            ...
            >
              ...
              <IconExternal
                size={18}
                aria-hidden="true"
                className="shrink-0 text-muted transition-transform duration-200 ease-(--ease-out) group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-ink"
              />
            </a>
          </li>
        ))}
      ...
      <p className="mt-2.5 text-[12px] leading-snug text-muted">
        Enlaces de afiliado: si compras, podemos recibir una comisión sin coste para ti. Nunca cambia tu nota ni el orden.
      </p>
    </div>
  );
}
