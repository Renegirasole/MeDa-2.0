        ...
        return (
          <li
            ...
            className={cn(
              ...
              isRecommended ? "border-brand-600 shadow-[0_0_0_1px_var(--color-brand-600)]" : "border-line",
            )}
          >
            {isRecommended && (
            ...
            <p className="num row-span-2 text-right text-[1.5rem] font-semibold tracking-[-0.03em] text-ink md:mt-5 md:text-left md:text-[2rem]">
              {formatEUR(amount)}
